...
# classroom 2200
set.seed(0708)
bergm_results[[1]][[1]] <- bergmM(networks[[1]]$gossip[[1]]~
                                     edges+mutual+
                                     gwodegree(decay=log(2),fixed=TRUE)+gwidegree(decay=log(2),fixed=TRUE)+
                                     odegree(d=0)+ 
                                     dgwdsp(decay=log(2),fixed=TRUE,type='OTP')+
                                     ...
                                     nodeifactor('roma')+
                                     nodeocov('popular')+nodeocov('popular2')+
                                     edgecov(networks[[1]]$dislike[[1]])+
                                     edgecov(networks[[1]]$dislike_2[[1]])+
                                     edgecov(networks[[1]]$shared_dislike[[1]])+
                                     edgecov(networks[[1]]$othersscorn[[1]])+
                                     edgecov(networks[[1]]$otherslookup[[1]]),
...
set.seed(0708)
bergm_results[[1]][[4]] <- bergmM(networks[[1]]$gossip[[4]]~
                                     edges+mutual+
                                     gwodegree(decay=log(2),fixed=TRUE)+gwidegree(decay=log(2),fixed=TRUE)+
                                     odegree(d=0)+ 
                                     dgwdsp(decay=log(2),fixed=TRUE,type='OTP')+
                                     ...
                                     nodeofactor('gender')+nodeifactor('gender')+nodematch('gender',diff=FALSE)+
                                     nodeocov('popular')+nodeocov('popular2')+
                                     edgecov(networks[[1]]$dislike[[4]])+
                                     edgecov(networks[[1]]$dislike_2[[4]])+
                                     edgecov(networks[[1]]$shared_dislike[[4]])+
                                     edgecov(networks[[1]]$othersscorn[[4]])+
                                     edgecov(networks[[1]]$otherslookup[[4]]),
                                   burn.in=1000,main.iters=5000,gamma=0.30,
...
set.seed(0708)
bergm_results[[2]][[2]] <- bergmM(networks[[2]]$gossip[[2]]~
                                     edges+
                                     gwodegree(decay=log(2),fixed=TRUE)+gwidegree(decay=log(2),fixed=TRUE)+
                                     odegree(d=0)+ 
                                     dgwdsp(decay=log(2),fixed=TRUE,type='OTP')+
                                     ...
                                     nodeifactor('roma')+
                                     nodeocov('popular')+nodeocov('popular2')+
                                     edgecov(networks[[2]]$dislike[[2]])+
                                     edgecov(networks[[2]]$dislike_2[[2]])+
                                     edgecov(networks[[2]]$shared_dislike[[2]])+
                                     edgecov(networks[[2]]$othersscorn[[2]])+
                                     edgecov(networks[[2]]$otherslookup[[2]]),
                                   burn.in=1000,main.iters=5000,gamma=0.32,
                                   prior.mean=c(rep(0,17)),prior.sigma=diag(5,17))
# classroom 6200 (no ethnicity)
set.seed(0708)
bergm_results[[2]][[3]] <- bergmM(networks[[2]]$gossip[[3]]~
                                     edges+mutual+
                                     gwodegree(decay=log(2),fixed=TRUE)+
                                     gwidegree(decay=log(2),fixed=TRUE)+
                                     odegree(d=0)+ 
                                     ...
                                     nodeofactor('gender')+nodeifactor('gender')+nodematch('gender',diff=FALSE)+
                                     nodeocov('popular')+nodeocov('popular2')+
                                     edgecov(networks[[2]]$dislike[[3]])+
                                     edgecov(networks[[2]]$dislike_2[[3]])+
                                     edgecov(networks[[2]]$shared_dislike[[3]])+
                                     edgecov(networks[[2]]$othersscorn[[3]])+
                                     edgecov(networks[[2]]$otherslookup[[3]]),
                                   burn.in=1000,main.iters=5000,gamma=0.25,
                                   prior.mean=c(rep(0,17)),prior.sigma=diag(5,17))
# classroom 6300 (no ethnicity and no mutual ties)
set.seed(0708)
bergm_results[[2]][[4]] <- bergmM(networks[[2]]$gossip[[4]]~
                                      edges+
                                      gwodegree(decay=log(2),fixed=TRUE)+
                                      gwidegree(decay=log(2),fixed=TRUE)+
                                      odegree(d=0)+ 
                                      ...
                                      nodeofactor('gender')+nodeifactor('gender')+nodematch('gender',diff=FALSE)+
                                      nodeocov('popular')+nodeocov('popular2')+
                                      edgecov(networks[[2]]$dislike[[4]])+
                                      edgecov(networks[[2]]$dislike_2[[4]])+
                                      edgecov(networks[[2]]$shared_dislike[[4]])+
                                      edgecov(networks[[2]]$othersscorn[[4]])+
                                      edgecov(networks[[2]]$otherslookup[[4]]),
                                    burn.in=1000,main.iters=5000,gamma=0.30,
                                    prior.mean=c(rep(0,16)),prior.sigma=diag(5,16))
# classroom 6400 (no ethnicity)
set.seed(0708)
bergm_results[[2]][[5]] <- bergmM(networks[[2]]$gossip[[5]]~
                                      edges+mutual+
                                      gwodegree(decay=log(2),fixed=TRUE)+
                                      gwidegree(decay=log(2),fixed=TRUE)+
                                      odegree(d=0)+ 
                                      ...
                                      nodeofactor('gender')+nodeifactor('gender')+nodematch('gender',diff=FALSE)+
                                      nodeocov('popular')+nodeocov('popular2')+
                                      edgecov(networks[[2]]$dislike[[5]])+
                                      edgecov(networks[[2]]$dislike_2[[5]])+
                                      edgecov(networks[[2]]$shared_dislike[[5]])+
                                      edgecov(networks[[2]]$othersscorn[[5]])+
                                      edgecov(networks[[2]]$otherslookup[[5]]),
                                    burn.in=1000,main.iters=5000,gamma=0.22,
                                    prior.mean=c(rep(0,17)),prior.sigma=diag(5,17))
# classroom 7600 (no gender and no sinks)
set.seed(0708)
bergm_results[[2]][[6]] <- bergmM(networks[[2]]$gossip[[6]]~
                                      edges+mutual+
                                      gwodegree(decay=log(2),fixed=TRUE)+gwidegree(decay=log(2),fixed=TRUE)+
                                      dgwdsp(decay=log(2),fixed=TRUE,type='OTP')+
                                      dgwesp(decay=log(2),fixed=TRUE,type='OTP')+
                                      nodeifactor('roma')+
                                      nodeocov('popular')+nodeocov('popular2')+
                                      edgecov(networks[[2]]$dislike[[6]])+
                                      edgecov(networks[[2]]$dislike_2[[6]])+
                                      edgecov(networks[[2]]$shared_dislike[[6]])+
                                      edgecov(networks[[2]]$othersscorn[[6]])+
                                      edgecov(networks[[2]]$otherslookup[[6]]),
                                    burn.in=1000,main.iters=5000,gamma=0.30,
                                    prior.mean=c(rep(0,14)),prior.sigma=diag(5,14))
...
set.seed(0708)
bergm_results[[3]][[1]] <- bergmM(networks[[3]]$gossip[[1]]~
                                     edges+mutual+
                                     gwodegree(decay=log(2),fixed=TRUE)+gwidegree(decay=log(2),fixed=TRUE)+
                                     dgwdsp(decay=log(2),fixed=TRUE,type='OTP')+
                                     dgwesp(decay=log(2),fixed=TRUE,type='OTP')+
                                     nodeifactor('roma')+
                                     nodeocov('popular')+nodeocov('popular2')+
                                     edgecov(networks[[3]]$dislike[[1]])+
                                     edgecov(networks[[3]]$dislike_2[[1]])+
                                     edgecov(networks[[3]]$shared_dislike[[1]])+
                                     edgecov(networks[[3]]$othersscorn[[1]])+
                                     edgecov(networks[[3]]$otherslookup[[1]]),
