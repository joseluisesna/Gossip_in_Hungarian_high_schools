...
bergm_results[[1]][[1]] <- bergmM(networks[[1]]$gossip[[1]]~
                                   ...
                                   burn.in=1000,main.iters=5000,gamma=0.4,
                                   prior.mean=c(rep(0,10)),prior.sigma=diag(5,10))
...
bergm_results[[1]][[5]] <- bergmM(networks[[1]]$gossip[[5]]~
                                   ...
                                   prior.mean=c(rep(0,9)),prior.sigma=diag(5,9))
# classroom 7800
set.seed(0708)
...
# Save image
save.image('bergm_results_null.RData')
